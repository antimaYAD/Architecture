  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center bg-gray-100">
      ...
      <div className="space-y-4">
        <button
          onClick={() => navigate("/canvas")}
          className="w-64 bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded shadow block"
        >
          Draw Floor Plan
        </button>
        ...
        <button
          ...
          className="w-64 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded shadow block"
        >
          Generate Floor Plan
        </button>
      </div>
